...
def show_main_window():
    ...
    chat_window = scrolledtext.ScrolledText(right_frame, wrap="word", height=18, width=75,
                                       bg="#1d1d1d",  # สีพื้นหลังเข้ม
                                       fg="#ff7f00",  # สีข้อความเป็นสีส้ม
                                       insertbackground="#a51300",  # สีเคอร์เซอร์เป็นสีส้ม
    ...
    message_entry = ctk.CTkEntry(right_frame, placeholder_text="> Type your message...",
                             font=("Consolas", 12), fg_color="#1a1a1a", text_color="#ff7f00")  # สีส้ม
    message_entry.pack(padx=12, pady=8, fill="x")
    message_entry.bind('<Return>', send_message)

    send_button = ctk.CTkButton(right_frame, text="➤ Send", command=send_message,
                            state=ctk.DISABLED, fg_color="#333333", hover_color="#ff7f00",  # สีส้มตอน hover
                            text_color="#ff7f00", corner_radius=10)  # สีส้ม
